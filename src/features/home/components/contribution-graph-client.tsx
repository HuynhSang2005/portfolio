...
/**
 * Heatmap đóng góp GitHub — resolve promise từ RSC bằng `use()`.
 *
 * @param contributions - Promise dữ liệu hoạt động từ `getContributions()`.
 */
...
/** Placeholder spinner khi Suspense đang chờ dữ liệu heatmap. */
