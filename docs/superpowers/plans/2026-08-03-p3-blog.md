...
describe("Heading", () => {
  ...
  it("renders anchor link when id is present", () => {
    render(<Heading as="h2" id="my-section">Title</Heading>);
...
describe("Table", () => {
  it("wraps the table in a not-prose bordered container", () => {
    ...
    expect(container.querySelector('[data-slot="table-container"]')!.className).toContain("not-prose");
  });
});
```
...
function Table({ className, ...props }: React.ComponentProps<"table">) {
  return (
    <div data-slot="table-container" className="not-prose my-6 w-full overflow-y-auto rounded-lg border">
      <table
        data-slot="table"
